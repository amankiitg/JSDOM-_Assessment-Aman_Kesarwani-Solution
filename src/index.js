...
function renderContact(contact) {
  ...
  const content =`<div class="card" data-id=${contact.id}>
...
*/
// console.log('Test Element',document.querySelectorAll("#filterOptions > option"));
// console.log('Test Length',document.querySelectorAll("#filterOptions > option").length);

// function formUpdate(contacts) {
...
function render(contacts) {
  ...
  console.log('Rendring Length',contacts.length)
  ...
  main.innerHTML = main.innerHTML + `<section id="contacts">` + content + `</section`;
...
function filterByCity(city) {
  ...
  const contactsFilteredByCity = contacts.filter((contact) => contact.address.city===city);
  return contactsFilteredByCity;
}
...
function filterHandler(event) {
  ...
  console.log(city);
  const updatedContacts = filterByCity(city);
  render(updatedContacts);
}
...
function loadCities(contacts) {
  ...
  const cityList = [... new Set(contacts.map((contact)=>contact.address.city))];
  console.log(cityList);

  const selectList = document.createElement("select");
  selectList.id = "filterOptions";
  selectList.name = "filterOptions";
  ...
  //form update
  document.getElementById("filterOptions").remove();
...
function deleteContact(id) {
  ...
  contacts = contacts.filter(function(contact) { return contact.id !== parseInt(id) });
  console.log('Length',contacts.length)
}
/*
...
function deleteButtonHandler(event) {
  ...
  if (event.target && event.target.nodeName == "BUTTON") {
    ...
    console.log(id);
    deleteContact(id);
    console.log("Rendering after delete");
    render(contacts);
  }
}
...
const filterForm = document.querySelector("#filterOptions");
...
function main() {
  ...
  allContacts.addEventListener("click", deleteButtonHandler);
  
}

// window.render([]);
// consol.log(document.querySelectorAll("#filterOptions > option").length)
